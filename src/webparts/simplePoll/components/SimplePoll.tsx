 ...
 */
export default class SimplePoll extends React.Component<ISimplePollWebPartProps, ISimplePollState> {
  ...
  private onVoteChanged(elm?: any): void {
    ...
    //commented by bharati - only below single line
...
*/
      listService.submitResponse(this.props.surveyList, this.state.questionInternalName, this.state.selectedValue);
      this.setState({
        popupOpened: true,
        resultsLoaded : false,
        results: []
